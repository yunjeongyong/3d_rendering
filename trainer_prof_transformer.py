...
from train_prof_transformer import train_epoch, eval_epoch
...
config = Config({
        ...
        "snap_path": "/media/mnt/Project/data/rgb_img_perceptual6",  # path for saving weights
        "save_img_path": "/media/mnt/Project/data/rgb_img_perceptual6",
