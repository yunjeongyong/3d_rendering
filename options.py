...
class TrainOptions():
    ...
    def __init__(self):
        ...
        train.add_argument('--face_structure_loss_weight', type=float, default=0.01,
                           help='weight of face-structure loss')
        train.add_argument('--mv_loss_weight', type=float, default=1, help='weight of multi-view loss')
        train.add_argument('--reid_norm_feat', type=int, default=1,
                           help='normalize feature or not? default do normalization, ie consine distance')
